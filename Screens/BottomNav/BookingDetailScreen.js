          ...
          <>
            ...
            {!bookingDetails.status && !bookingCanceled ? (
              ...
              <Text style={styles.message}>
                {bookingDetails.status ? 'Cancelled' : (bookingCanceled ? 'Completed' : '')}
              </Text>
            )}
            <Text style={styles.messages}>You can only cancel if the driver is not accepting your request.</Text>
          </>
        ) : (
          <Text>No booking details found.</Text>
        )}
